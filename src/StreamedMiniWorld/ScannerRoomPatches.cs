...
{
    internal static readonly ConditionalWeakTable<MiniWorld, MapRoomFunctionality> 
    ...
    private static class AddOnStart {
        private static void Prefix(MapRoomFunctionality __instance)
            => RegisterMapRoom(__instance);
    }
