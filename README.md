...
Older versions of these games may require using old versions of Terrain Patcher, which are
unsupported. Please do not submit issues for old versions of Terrain Patcher.
